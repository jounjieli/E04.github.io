...
console.log('%cEO4 演唱會 🎵', 'color: #D4AF37; font-size: 24px; font-weight: bold;');
console.log('%c2025.11.01 | Words Live 忠明館', 'color: #666; font-size: 14px;');
console.log('%cDeveloped with ❤️ for Music Lovers', 'color: #999; font-size: 12px;');
